...
import com.crystallake.statusbarutil.utils.ContextUtils;
import com.crystallake.statusbarutil.utils.LuminanceUtils;
import com.crystallake.statusbarutil.utils.TransparentUtils;
...
public class StatusBarUtils {
    ...
    public static double calcBgLuminance(@NonNull Window window) {
        if (StatusBarUtils.isTransparent(window)) {
    ...
    public static boolean isIconDark(@NonNull Fragment fragment) {
        return OsCompatHolder.create().isDarkIconMode(fragment);
    }

    public static boolean isIconDark(@NonNull Context context) {
        Activity activity = ContextUtils.getActivity(context);
        if (activity == null) return false;
        return OsCompatHolder.create().isDarkIconMode(activity);
    }
    ...
    public static boolean isIconDark(@NonNull Window window) {
        return OsCompatHolder.create().isDarkIconMode(window);
    }
    ...
    public static void setIconMode(@NonNull Fragment fragment, boolean darkIconMode) {
        OsCompatHolder.create().setDarkIconMode(fragment, darkIconMode);
    }

    public static void setIconMode(@NonNull Context context, boolean darkIconMode) {
        Activity activity = ContextUtils.getActivity(context);
        if (activity == null) return;
        OsCompatHolder.create().setDarkIconMode(activity, darkIconMode);
    }
    ...
    public static void setIconMode(@NonNull Window window, boolean darkIconMode) {
        OsCompatHolder.create().setDarkIconMode(window, darkIconMode);
    }
